...
namespace eval thc_Web::API {
	...
	#    > -> {
	#    >    "Light1stFloor_state":
	#    >      {"name":"Light1stFloor","type":"switch","range":"","step":"","group":"Light","format":"%s"},
	#    >    "Temperature1stFloor_state":
  	#    >      {"name":"Temperature1stFloor","type":"level","range":"","step":"","group":"Environment","format":"%sC"},
	#    >    "Humidity1stFloor_state":
  	#    >      {"name":"Humidity1stFloor","type":"level","range":"","step":"","group":"Environment","format":"%s%%"}
	#    >    }
	##########################
